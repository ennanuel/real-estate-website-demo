...
import { PiGlobeHemisphereEast, PiTelegramLogoLight, PiWhatsappLogoLight } from 'react-icons/pi';
    ...
    <div className='font-montserrat text-gray-900'>
      <header className='bg-white sticky top-0 z-10 px-10'>
        <div className="mx-auto max-w-large flex items-center justify-between h-20">
          <a href="#!" className='flex items-center gap-2 text-brown-dark'>
            <FaBuilding size={40} />
        ...
        <div className="mx-auto max-w-large">
          {
            ...
            ].slice(0, 1).map(({ title, desc, image }) => (
